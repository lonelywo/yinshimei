...
public class ItemGould2ViewBinder extends ItemViewBinder<PoiItem, ItemGould2ViewBinder.ViewHolder> {
    ...
    public ItemGould2ViewBinder(ItemGould2ViewBinder.OnItemClickListener onItemClickListener) {
