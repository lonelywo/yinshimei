...
public class ShareImgTipsPopup extends BottomPopupView {
    ...
    public ShareImgTipsPopup(@NonNull Context context, String cancel, OnExitListener listener) {
        super(context);
        mContext = context;
    ...
    protected int getImplLayoutId() {
        return R.layout.popup_share_img_tips_view;
    }
