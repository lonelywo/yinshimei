...
public class CartTipsPopup extends CenterPopupView {
    ...
    public CartTipsPopup(@NonNull Context context, String desc, String cancel, String ok, OnExitListener listener) {
        super(context);
