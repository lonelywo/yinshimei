...
public class _KaQuanFragment02 extends BaseFragment implements OnRefreshLoadMoreListener, ItemKaQuanViewBinder2.OnPKClickListener {
    ...
    private void load() {
        page = 1;
        mViewModel.kaquanlist(mUserInfo.getToken(),String.valueOf(mUserInfo.getId()),"2", "1", "10", "1", Status.LOAD_REFRESH)
    ...
    public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
        if (mCanLoadMore) {
            mCanLoadMore = false;
            mViewModel.kaquanlist(mUserInfo.getToken(),String.valueOf(mUserInfo.getId()),"2", page+"", "10", "1", Status.LOAD_MORE)
                    .observe(this, mObserver);
