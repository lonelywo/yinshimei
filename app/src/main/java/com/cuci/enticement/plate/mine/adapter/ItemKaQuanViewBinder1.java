...
public class ItemKaQuanViewBinder1 extends ItemViewBinder<KaQuanListBean.DataBean.ListBean, ItemKaQuanViewBinder1.ViewHolder> {
    ...
    public ItemKaQuanViewBinder1(OnPKClickListener onProdClickListener) {
    ...
    protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View root = inflater.inflate(R.layout.rec_kaquan, parent, false);
        return new ViewHolder(root);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull KaQuanListBean.DataBean.ListBean item) {
