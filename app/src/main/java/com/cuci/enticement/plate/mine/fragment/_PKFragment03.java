 ...
 * 首页外层Fragment
 */
public class _PKFragment03 extends BaseFragment implements OnRefreshLoadMoreListener, ItemPKViewBinder.OnPKClickListener {

    private static final String TAG = _PKFragment03.class.getSimpleName();
    ...
    public static _PKFragment03 newInstance(String type) {
        ...
        _PKFragment03 fragment = new _PKFragment03();
    ...
    private void opera1(ResponseBody body, Status status) {
        try {
            ...
            PKbean3 mPKbean1 = new Gson().fromJson(b, PKbean3.class);
            int teams = mPKbean1.getData().getMyself().getTeams();
    ...
    @Override
    public void onProdClick(PKbean3.DataBean.ListBean item) {
