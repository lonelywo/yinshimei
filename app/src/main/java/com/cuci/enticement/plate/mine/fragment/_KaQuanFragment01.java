 ...
 * 首页外层Fragment
 */
public class _KaQuanFragment01 extends BaseFragment implements OnRefreshLoadMoreListener, ItemKaQuanViewBinder1.OnPKClickListener {

    private static final String TAG = _KaQuanFragment01.class.getSimpleName();
    ...
    public static _KaQuanFragment01 newInstance(String type) {
        Bundle args = new Bundle();
        args.putString("type", type);
        _KaQuanFragment01 fragment = new _KaQuanFragment01();
    ...
    protected void initViews(LayoutInflater inflater, View view, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter.register(KaQuanListBean.DataBean.ListBean.class, new ItemKaQuanViewBinder1(this));
