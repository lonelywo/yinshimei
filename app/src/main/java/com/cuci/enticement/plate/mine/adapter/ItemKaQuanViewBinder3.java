...
public class ItemKaQuanViewBinder3 extends ItemViewBinder<KaQuanListBean.DataBean.ListBean, ItemKaQuanViewBinder3.ViewHolder> {
    ...
    private ItemKaQuanViewBinder3.OnPKClickListener mOnProdClickListener;

    public ItemKaQuanViewBinder3(ItemKaQuanViewBinder3.OnPKClickListener onProdClickListener) {
        mOnProdClickListener = onProdClickListener;
    }

    @NonNull
    @Override
    protected ItemKaQuanViewBinder3.ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View root = inflater.inflate(R.layout.rec_kaquan31, parent, false);
        return new ItemKaQuanViewBinder3.ViewHolder(root);
    }

    @Override
    protected void onBindViewHolder(@NonNull ItemKaQuanViewBinder3.ViewHolder holder, @NonNull KaQuanListBean.DataBean.ListBean item) {
