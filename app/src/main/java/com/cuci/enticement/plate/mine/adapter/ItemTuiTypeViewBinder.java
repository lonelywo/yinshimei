...
public class ItemTuiTypeViewBinder extends ItemViewBinder<OrderGoods, ItemTuiTypeViewBinder.ViewHolder> {
    ...
    public ItemTuiTypeViewBinder(OnProdClickListener onProdClickListener) {
