...
import com.cuci.enticement.plate.mine.adapter.ItemKaQuanViewBinder3;
 ...
 * 首页外层Fragment
 */
public class _KaQuanFragment03 extends BaseFragment implements OnRefreshLoadMoreListener, ItemKaQuanViewBinder3.OnPKClickListener {

    private static final String TAG = _KaQuanFragment03.class.getSimpleName();
    ...
    public static _KaQuanFragment03 newInstance(String type) {
        Bundle args = new Bundle();
        args.putString("type", type);
        _KaQuanFragment03 fragment = new _KaQuanFragment03();
    ...
    protected void initViews(LayoutInflater inflater, View view, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter.register(KaQuanListBean.DataBean.ListBean.class, new ItemKaQuanViewBinder3(this));
    ...
    private void load() {
        page = 1;
        mViewModel.kaquanlist(mUserInfo.getToken(),String.valueOf(mUserInfo.getId()),"2", "1", "10", "2",""+ AppUtils.getVersionCode(mActivity), Status.LOAD_REFRESH)
    ...
    public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
        if (mCanLoadMore) {
            mCanLoadMore = false;
            mViewModel.kaquanlist(mUserInfo.getToken(),String.valueOf(mUserInfo.getId()),"2", page+"", "10", "2",""+ AppUtils.getVersionCode(mActivity), Status.LOAD_MORE)
                    .observe(this, mObserver);
